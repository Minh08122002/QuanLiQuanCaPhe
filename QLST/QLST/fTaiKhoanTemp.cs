...
namespace QLST
{
    public partial class fTaiKhoanTemp : Form
    {
      
        private int pageNumber;
        private int page = 1;
        public fTaiKhoanTemp()
        {
            InitializeComponent();
            loadPageNumber();
        ...
        private void fTaiKhoanTemp_Load(object sender, EventArgs e)
        {
        ...
        private void loadRecord(int page)
        {
            ...
            TaiKhoanBUS.Instance.loadRecord(dtGVDanhSachTK, page,0,str);
        }
        ...
        {
            TaiKhoanBUS.Instance.searchTaiKhoan(dtGVDanhSachTK, txtTimkiem.Text.ToString(),"TEN_TAIKHOAN",0);
        }
        ...
        private void txtTimkiem_TextChanged_1(object sender, EventArgs e)
        {
            ...
            TaiKhoanBUS.Instance.searchTaiKhoan(dtGVDanhSachTK, txtTimkiem.Text.ToString(), "TEN_TAIKHOAN", 0, array);
        ...
        {
            //fTaiKhoanTempTemp f = new fTaiKhoanTempTemp();
            //f.Show();
        }
        ...
        private void rjButton1_Click(object sender, EventArgs e)
        {
            ...
            fThongTinTaiKhoanTemp f = new fThongTinTaiKhoanTemp(tk);
            f.Show();
        }
    }
}
